    ...
    <footer className="footer sm:footer-horizontal bg-base-300 text-base-content p-10 bg-(--primary-blue)">
      ...
      <div className="w-full mt-6 flex flex-col items-center">
        ...
        <nav aria-label="Sociale medier" className="flex gap-6 items-center text-2xl mt-2">
          ...
          <a href="https://www.instagram.com/kraess.store/" aria-label="Instagram" className="hover:scale-120 hover:duration-300 ease-in-out transition-transform">
            <FaInstagram />
          </a>
          <a href="https://www.tiktok.com/@kraess.store" aria-label="TikTok" className="hover:scale-120 hover:duration-300 ease-in-out transition-transform">
            <FaTiktok />
          </a>
        </nav>
      </div>
