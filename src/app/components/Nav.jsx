    ...
    <>
      ...
      {navActive && (
        <ul id="nav-links" className="fixed top-1/2 left-1/2 z-50 flex h-full w-full -translate-x-1/2 -translate-y-1/2 flex-col justify-center gap-0 rounded-lg border p-4 text-center uppercase">
          ...
          <li>
            <Link href="/productlist" onClick={() => setNavActive(false)} className="block px-4 py-3 text-black">
              Værker
            </Link>
          </li>
          <li>
            <Link href="/artists" onClick={() => setNavActive(false)} className="block px-4 py-3 text-black">
              Kunstnere
            </Link>
          </li>
          <li>
            <Link href="/about" onClick={() => setNavActive(false)} className="block px-4 py-3 text-black">
              Om Kæntt
            </Link>
          </li>
          <li>
            <Link href="/events" onClick={() => setNavActive(false)} className="block px-4 py-3 text-black">
              Events
            </Link>
          </li>
          <li>
